...
VanetRoutingExperiment::VanetRoutingExperiment ()
  : m_port (9),
    m_CSVfileName ("hi1.csv"),
    m_CSVfileName2 ("hi2.csv"),
    m_nSinks (10),
...
static ns3::GlobalValue g_traceFile ("VRCtraceFile",
                                     ...
                                     ns3::StringValue ("./scratch/mobility.ns_movements"),
                                     ns3::MakeStringChecker ());
static ns3::GlobalValue g_logFile ("VRClogFile",
                                   "Log filename",
                                   ns3::StringValue ("hello.log"),
                                   ns3::MakeStringChecker ());
